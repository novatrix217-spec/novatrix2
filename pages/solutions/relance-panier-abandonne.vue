...
const seoMeta = computed(() => locale.value === 'en'
  ...
  : { title: 'Relance des paniers abandonnés : Shopify et au-delà', description: 'Une automatisation qui détecte les paniers abandonnés et relance par SMS, email ou WhatsApp au bon moment. Système déjà déployé sur Shopify avec Twilio.' })
