...
const seoMeta = computed(() => locale.value === 'en'
  ? { title: 'Six systems to acquire, operate and grow', description: 'Acquisition, AI piloting, Novatrix Launch, e-commerce retention, AI video and custom web & apps: six systems scoped around your actual bottleneck.' }
  : { title: 'Six systèmes pour acquérir, piloter et grandir', description: 'Acquisition, pilotage IA, Novatrix Launch, rétention e-commerce, créatifs vidéo IA et web & apps : six systèmes cadrés autour de votre blocage réel.' })
