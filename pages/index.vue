  ...
  <div ref="revealRoot">
    ...
    <section id="problemes" ref="problemsSectionEl" class="section-pad relative overflow-hidden scroll-mt-24">
      <div class="container-shell relative z-10">
        <div class=""><SectionHeading :kicker="t.problemsKicker" center :description="t.problemsDescription">{{ t.problemsTitle1 }} <span class="text-gradient">{{ t.problemsTitle2 }}</span></SectionHeading></div>
...
const t = computed(() => locale.value === 'en' ? {
  heroTitle: 'Turn more of your prospects into meetings, <span class="text-gradient-flow">without losing them between your tools.</span>', heroDescription: 'Campaigns, conversion pages, CRM and follow-up connected into one AI-powered sales system.', seeProof: 'See delivered work', contactUs: 'Contact us directly', whatsappUs: 'Or message us on WhatsApp',
