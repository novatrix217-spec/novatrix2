...
const ogImageUrl=computed(()=>coverUrl.value||(article.value?.seo?.ogImage?`${site}${article.value.seo.ogImage}`:''))
usePageSeo(() => localizedSeoTitle.value, () => localizedSeoDesc.value, () => ogImageUrl.value || '/og-default.png')
